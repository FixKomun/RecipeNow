<template>
  <div class="box">
    <b-row class="nav" align-content="center">
    ...
    <b-container>
      <b-row class="content">
        <b-col class="left" cols="5">
          <h1>Welcome!</h1>
          <h2>Already have an account?</h2>
          <p>
            Log in now and start
            <br />creating your custom recipes!
          </p>
        ...
        <b-col class="right" cols="7">
          ...
          <Button @click="register" :disabled="isLogging" :loading="isLogging">
            Register now
            <svg
              width="28"
              height="28"
...
export default {
  ...
  methods: {
    async register() {
      this.isLogging = true;
      const res = await this.callApi("post", "/app/register", this.userData);
      if (res.status === 200) {
        console.log(res);
